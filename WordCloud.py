...
class TagCloud(object):
    ...
    def _findCoordinates(self, index, text, weight):
        ...
        self.words_to_draw.append({'text': text, 'fontsize': fontsize, 'x': x, 'y': y, 'w': width, 'h': height,
        ...
        for word in self.words_to_draw:
            if self._liesInside(word):
                self.imageDraw.text((word['x'], word['y']), word['text'],
                                    font=ImageFont.truetype(self.FONT, word['fontsize']), fill=word['color'])
    ...
    def _liesInside(self, word):
        ...
        if word['x'] >= 0 and word['x'] + word['w'] <= self.width and word['y'] >= 0 and word['y'] + word[
            'h'] <= self.height:
            return True
...
if __name__ == '__main__':
    ...
    data_bank = [{"text": "coffee", "weight": 20296.0}, {"text": "love", "weight": 15320.0},
             ...
             {"text": "new", "weight": 3700.0}, {"text": "lol", "weight": 3536.0}, {"text": "yum", "weight": 3282.0},
             {"text": "drink", "weight": 3246.0}, {"text": "latte", "weight": 3219.0},
             {"text": "time", "weight": 3137.0}, {"text": "caramel", "weight": 3125.0},
             {"text": "friends", "weight": 3084.0}, {"text": "tagsforlikes", "weight": 3005.0},
             {"text": "beautiful", "weight": 2892.0}, {"text": "food", "weight": 2801.0},
             {"text": "life", "weight": 2780.0}, {"text": "delicious", "weight": 2767.0},
             {"text": "f4f", "weight": 2670.0}, {"text": "follow4follow", "weight": 2667.0},
             {"text": "white", "weight": 2614.0}, {"text": "tea", "weight": 2577.0},
             {"text": "selfie", "weight": 2559.0}, {"text": "best", "weight": 2522.0},
             {"text": "swag", "weight": 2494.0}, {"text": "got", "weight": 2491.0}, {"text": "work", "weight": 2479.0},
