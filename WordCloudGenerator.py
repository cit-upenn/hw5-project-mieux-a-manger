...
def get_reviews (business_id, review_ct, ds_txt):
...
def generate_wordcloud(business_id, ds_txt):
    """
    ...
    reviews = get_reviews(business_id, review_ct, ds_txt)
    summarizer.run(reviews, 50, "test.jpg")
...
if __name__ == "__main__":
    ...
    # reviews = get_reviews (business_id, review_ct, file)
    # print(reviews)